<template>
    <div class="card" :class="{ loading: isLoading }">
        ...
        <div v-else class="card__image loading bg-snow-vei"></div>
        ...
        <div v-else class="card__rating w-full h-4 loading bg-snow-vei"></div>

        <h2 v-if="!isLoading" class="card__name">{{ plant.name }}</h2>
        <div v-else class="card__name w-full flex">
            <div class="w-[45%] h-4 loading bg-snow-vei mr-4"></div>
            <div class="w-[25%] h-4 loading bg-snow-vei mr-auto"></div>
        </div>
        ...
        <div v-else class="card__price w-[25%] h-4 loading bg-snow-vei mr-auto"></div>
...
.card {
    ...
    &__image {
        @apply relative min-w-[230px] h-[320px] rounded-xl bg-snow-vei flex justify-center items-center;
